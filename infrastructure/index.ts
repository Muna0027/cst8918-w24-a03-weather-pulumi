...
const prefixName = config.get('prefixName') || 'cst8918-a03-adan0027';
...
const registry = new containerregistry.Registry(`${prefixName}acr123`, {
    resourceGroupName: resourceGroup.name,
    adminUserEnabled: true,
    sku: {
      name: containerregistry.SkuName.Basic
    },
    registryName: registryName  // Replace with a valid lowercase alphanumeric name
})
